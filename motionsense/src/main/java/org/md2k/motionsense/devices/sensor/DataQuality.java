...
public class DataQuality {
    ...
    public final static float MAGNITUDE_VARIANCE_THRESHOLD = (float) 0.50;   //this threshold comes from the data we collect by placing the wrist sensor on table. It compares with the wrist accelerometer on-body from participant #11 (smoking pilot study)
